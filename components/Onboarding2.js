...
const Onboarding2 = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View>
                <Image source={require("../assets/Onboarding/onboarding2.png")} style={{ alignSelf: "center" }} />
            </View>
            <Text style={{ fontSize: 24, fontWeight: "bold", color: "black", textAlign: "center", marginTop: 12 }}>Your Bookish Soulmate</Text>
            ...
            <View style={{ marginTop: 38, flexDirection: 'row', alignSelf: 'center', alignItems: 'center' }}>
            ...
            <View style={{ marginTop: 35 }}>
                <TouchableHighlight><Text style={styles.btncontinue} onPress={()=> navigation.navigate("Onboarding3")}>Get Started</Text></TouchableHighlight>
            </View>
